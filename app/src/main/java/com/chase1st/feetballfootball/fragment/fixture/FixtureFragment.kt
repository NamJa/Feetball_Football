...
import com.chase1st.feetballfootball.viewModel.FeetballFootballViewModel
...
//        window.statusBarColor = ContextCompat.getColor(requireContext(), R.color.white)
        ...
        val dividerItemDecoration = com.chase1st.feetballfootball.util.DividerItemDecoration(
